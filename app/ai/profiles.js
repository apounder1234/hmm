...
export const aiStrategyProfiles = {
    ...
    fossilTempo: {
        ...
        pathwayWeights: { solar: 1.25, wind: 1.25, hydro: 1.0, biomass: 0.8, fossil: 2.1 },
        stageWeights: { ...sharedStages, capture: 1.15, transformation: 1.4, transport: 1.2, efficiency: 1.3 },
        resourceWeights: { ...sharedResources, fossilFuel: 1.25 }, reliabilityWeight: 1.5, forecastWeight: 0.8,
        lossAversion: 0.8, depletionAversion: 1.45, diversificationWeight: 0.9, storageReserveTarget: 1
    },
    diversifiedAdapter: {

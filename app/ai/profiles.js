...
export const aiStrategyProfiles = {
    ...
    fossilTempo: {
        id: "fossilTempo", name: "Fossil Tempo", preparedPathway: "fossil", preparedCapability: "transformation",
        pathwayWeights: { solar: 0.6, wind: 0.6, hydro: 0.65, biomass: 0.75, fossil: 2.7 },
        stageWeights: { ...sharedStages, transformation: 1.6, transport: 1.2, efficiency: 1.25 },
        resourceWeights: { ...sharedResources, fossilFuel: 1.6 }, reliabilityWeight: 1.55, forecastWeight: 0.35,
        lossAversion: 0.55, depletionAversion: 0.7, diversificationWeight: 0.15, storageReserveTarget: 0
    },
    diversifiedAdapter: {

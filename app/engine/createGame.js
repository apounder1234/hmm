...
function createMarket(config, state) {
    const advanced = shuffle(config.technologies.filter(t => t.tier === "advanced").map(t => t.id), state.streams.market);

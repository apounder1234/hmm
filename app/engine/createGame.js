...
import { getStartingTechnologyIds } from "./continentRules.js";
import { setSummitForecast } from "./weather/weather.js";
...
function createPlayer(config, setup) {
    ...
    return {
        ...
        assistanceKnowledge: 0, appliedLearningTokens: 0, knowledgeLinkUsed: false,
        prepared: {
        ...
        installed, localCondition: null, actionsRemaining: 0, completedTrades: 0, initiatedTrades: 0, assistanceLent: false,
...
export function createGame(config, players, seed, options = {}) {
    ...
    const state = {
        schemaVersion: "1.0.0", engineVersion: "0.11.0-asymmetric-continents",
        ...
        opening: {
            mode: openingMode,
            revealed: false,
            summit: { round: 0, direction: null, order: [], activeIndex: 0, pendingOffer: null, completed: openingMode !== "energySummit" },

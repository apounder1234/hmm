...
export function hasRelevantSystem(state, player, kind) {
    switch (kind) {
        case "hydroDelta": return hasTechnology(player, "basicReservoir") || hasTechnology(player, "advancedReservoir");
        ...
        case "biomassRegrowthSet": return hasTechnology(player, "managedForest");

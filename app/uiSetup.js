    ...
    return h("div", { className: "continent-selection-layout" },
        ...
        h("article", { className: "continent-focus-card" },
            ...
            h("div", { className: "continent-essentials" },
                ...
                h("div", null, h("small", null, "Likely import need"), h("strong", null, continent.tradeNeed))
            ),
            ...
            h("details", { className: "continent-details" },
                ...
                h("div", { className: "opportunity-list compact-opportunities" }, ...Object.entries(continent.opportunities).map(([path, value]) => h("div", { key: path }, h("span", null, pathwayLabels[path]), meter(value))))
            ),

        ...
        content = h("section", { className: "setup-stage" },
            ...
            h("div", { className: "opening-choice-grid" },
                ...
                h("button", { type: "button", className: `opening-choice-card ${openingMode === "energySummit" ? "selected" : ""}`, onClick: () => setOpeningMode("energySummit") },
                    h("span", { className: "opening-icon" }, "⇄"), h("p", { className: "eyebrow" }, "Secret Energy Summit"), h("h2", null, "Energy Summit"), h("p", null, "Choose a secret plan, trade with both opening conditions visible, then begin your Founding Project."), h("ul", null, h("li", null, "More negotiation"), h("li", null, "Two trades per player"), h("li", null, "Generation 1 weather and Generation 2 forecast visible before trading"))
                )
            ),
            openingMode === "energySummit" ? h("details", { className: "summit-explainer" }, h("summary", null, "How the Summit works"), h("ol", null, h("li", null, "Everyone locks a secret Starting Pathway and Capability."), h("li", null, "Generation 1 weather and the Generation 2 forecast are revealed."), h("li", null, "Trade proceeds right-to-left, then left-to-right."), h("li", null, "Each player may complete at most two Summit trades."), h("li", null, "The Summit moves directly to each Founding Project."))) : null
        );
    }
    else {
...
function EnergySummit({ game, command }) {
    ...
    return panel(`Energy Summit · Round ${summit.round}`, h("div", { className: "summit-board redesigned-summit" },
        h("div", { className: "opening-weather-strip", "aria-label": "Opening weather" },
            h(WeatherCard, { label: "Generation 1 · Current", face: game.weather.current }),
            h("span", { className: "weather-arrow", "aria-hidden": "true" }, "→"),
            h(WeatherCard, { label: "Generation 2 · Forecast", face: game.weather.forecast, forecast: true })
        ),
        h("div", { className: "summit-direction" }, h("span", null, summit.direction === "rightToLeft" ? "←" : "→"), h("div", null, h("strong", null, summit.direction === "rightToLeft" ? "Right-to-left sweep" : "Left-to-right sweep"), h("small", null, "Trade with both opening conditions visible"))),

...
export const continents = [
    ...
    },
    {
        ...
        systemAffinity: { transmission: "standard", storage: "standard", lighting: "standard" },
        strengths: ["Once per Generation, Other Materials extraction yields 2", "Grid Level 2", "Hydro signature bonus in Rain or Storm"],
    ...
    },
    {
        ...
        systemAffinity: { transmission: "standard", storage: "standard", lighting: "standard" },
        strengths: ["Once per Generation, Fuel extraction yields 2", "Ten total Fuel", "Efficient LED Lighting"],
    ...
    },
    {
        ...
        systemAffinity: { transmission: "standard", storage: "standard", lighting: "standard" },
        strengths: ["Once per Generation, Biomass extraction yields 2", "Large Biomass and Critical Materials stocks", "Grid Level 2"],
    ...
    },
    {
        ...
        pathwayAffinity: { solar: "standard", wind: "strong", hydro: "standard", biomass: "standard", fossil: "standard" },
        systemAffinity: { transmission: "standard", storage: "standard", lighting: "standard" },
        strengths: ["Once per Generation, Critical Materials extraction yields 2", "Solar signature bonus in Bright Sun", "Efficient LED Lighting"],
...
export const weather = {
    faces,
    solar: {
        brightSun: [0, 1, 2, 3, 4, 5], rain: [0, 0, 1, 1, 2, 2], strongWind: [0, 0, 1, 1, 2, 2], storm: [0, 0, 0, 1, 1, 1], calmOvercast: [0, 0, 1, 2, 3, 4]
    },
    wind: {

...
export function createRandomState(seed) {
    return { seed, streams: { weather: makeStream(`${seed}::weather`), conditions: makeStream(`${seed}::conditions`), globalEvents: makeStream(`${seed}::globalEvents`), market: makeStream(`${seed}::market`), ai: makeStream(`${seed}::ai`), simulation: makeStream(`${seed}::simulation`) } };
}

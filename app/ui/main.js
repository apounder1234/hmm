...
function technologyExplanation(tech) {
    ...
    if (tech.fuel) {
        ...
        if (tech.pathway === "fossil")
            details.push("Fossil output does not automatically weaken as stock falls. The pressure comes from the finite cubes: every operation consumes one, and only Knowledge-5 fuel technology can supply the four-Light late-game target by itself.");
    }
    if (tech.storage)

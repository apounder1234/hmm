...
export function createGame(config, players, seed, options = {}) {
    ...
    const state = {
        schemaVersion: "1.2.0", engineVersion: "0.19.0-map-interaction-fixes",
...
function migratePhase3State(input) {
    ...
    // Canonical A.5.9 configuration replaces conflicting historic runtime values.
    state.config = structuredClone(defaultConfig);
    state.schemaVersion = "1.2.0";
    state.engineVersion = "0.19.0-map-interaction-fixes";

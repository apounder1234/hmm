...
export function createGame(config, players, seed, options = {}) {
    ...
    const state = {
        schemaVersion: "1.3.0", engineVersion: "0.20.0-storage-global-events",
...
function migratePhase3State(input) {
    ...
    state.schemaVersion = "1.3.0";
    state.engineVersion = "0.20.0-storage-global-events";
...
export function deserializeGame(json) {
    ...
    if (!["1.0.0", "1.1.0", "1.2.0", "1.3.0"].includes(envelope.saveSchemaVersion))

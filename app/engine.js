...
export function createGame(config, players, seed, options = {}) {
    ...
    const state = {
        schemaVersion: "1.5.0", engineVersion: "0.22.0-uniform-starting-infrastructure",
...
function migratePhase3State(input) {
    ...
    state.schemaVersion = "1.5.0";
    state.engineVersion = "0.22.0-uniform-starting-infrastructure";
...
export function deserializeGame(json) {
    ...
    if (!["1.0.0", "1.1.0", "1.2.0", "1.3.0", "1.4.0", "1.5.0"].includes(envelope.saveSchemaVersion))
